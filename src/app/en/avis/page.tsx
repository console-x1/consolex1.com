...
async function getGoogleReviews(): Promise<GoogleReviewsPayload & { error?: string }> {
  try {
    ...
    return {
      ...
      reviews: [],
      error: 'Google reviews are temporarily unavailable. Please try again in a few moments.',
    };
  }
}
...
export const metadata = {
  ...
  description: 'See Consolex1 customer reviews and the live Google rating from our public review source.',
};
  ...
  return (
    <section className="section reviews-page">
      <div className="section-header">
        ...
        <h1>What our clients say about Consolex1</h1>
        <p className="section-description">
          The overall score and the latest Google reviews are loaded automatically from our live source.
        </p>
      </div>
      ...
      <div className="review-overview">
        <div className="rating-summary">
          <div className="rating-display">
            ...
            <div className="rating-stars" aria-label={`Google rating ${formattedRating} out of 5`}>
          ...
          <div className="rating-meta">
            <strong>{formatCount(user_ratings_total)} Google reviews</strong>
            <span>Google Reviews</span>
          </div>
        </div>

        <div className="reviews-cta">
          <p>View the public reviews directly on Google.</p>
          <a
      ...
      {error ? (
        ...
        <div className="reviews-grid">
          {reviews.map((review, index) => {
            ...
            const text = review.text || 'Public review available on Google.';
            ...
            return (
              <article key={`${author}-${index}`} className="review-card">
                <div className="review-header">
                  ...
                  <div className="review-rating" aria-label={`Rating ${review.rating ?? 0} out of 5`}>
